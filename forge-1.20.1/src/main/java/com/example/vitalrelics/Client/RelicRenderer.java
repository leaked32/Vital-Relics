...
public final class RelicRenderer extends BlockEntityWithoutLevelRenderer {
	...
	public void renderByItem(
		...
		vertex(vertices, matrix, -0.5F, -0.5F, 0.0F,
				0.0F, 1.0F, renderLight, overlay);

		vertex(vertices, matrix, 0.5F, -0.5F, 0.0F,
				1.0F, 1.0F, renderLight, overlay);

		vertex(vertices, matrix, 0.5F, 0.5F, 0.0F,
				1.0F, 0.0F, renderLight, overlay);

		vertex(vertices, matrix, -0.5F, 0.5F, 0.0F,
				0.0F, 0.0F, renderLight, overlay);
