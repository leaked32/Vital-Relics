...
Relics provide much more than ordinary attribute bonuses.

Depending on the relic, they can regenerate health, improve movement, modify attacks, empower or redirect projectiles, repair equipment, grant flight, provide active abilities, or fundamentally change how you approach combat.

Multiple relics can be equipped together, allowing their effects and abilities to complement each other.

## Spell System

Some relics provide active spells.

Use **Shift + Mouse Wheel** to switch between available spells and press the configured spell key to cast the selected spell. The spell HUD displays the currently selected spell and its cooldown.

Available abilities include teleportation, healing, curses, movement abilities, crowd control, combat spells, and other relic-specific effects.
...
Players are not the only ones who can use relics.
...
Vital Relics is actively developed.

If you encounter a reproducible bug, compatibility problem, or crash, please report it through the [GitHub Issues page](https://github.com/leaked32/Vital-Relics/issues) with relevant logs and configuration details when possible.

## Screenshots

![Vital Relics](https://github.com/user-attachments/assets/a3e49454-14e9-4b9c-894c-727dfe9d1050)

![Vital Relics](https://github.com/user-attachments/assets/aabf218f-aa11-4787-9083-5bf32bb71a3e)

![Vital Relics](https://github.com/user-attachments/assets/c931d595-af92-4843-b82f-299709a0f4a0)
